...
<center>
	<form action="f_write_ok.jsp" method="post" name="faq_frm">
	<p>
		FAQ 글 쓰기
	</p>
		<table>
			<tr>
				<td>글제목</td>
				<td colspan="3"><input type="text" name="f_title"></td>
				<te>
			</tr>
			<tr>
				<td>글분류</td>
				<td><input type="text" name="f_category" size="30"> </td>
			</tr>
			<tr>
				<td colspan="4">
					<textarea rows="5" cols="100" name="f_content"></textarea>
				</td>
			</tr>
			<tr>
				<td colspan="4" align="center">
					<input type="button" value="글쓰기" onclick="write_ok()">&nbsp;
					<input type="reset" value="다시작성">&nbsp;
					<input type="button" value="글목록" onclick="location.href='faq.jsp?u_id=<%= u_id %>&pageNum=<%= pageNum %>'">
			</tr>
		</table>
	</form>
</center>
